          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text('SecureSign', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.blue)),
                SizedBox(height: 24),
                Text('Sign In', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                SizedBox(height: 8),
                Text('Enter your credentials to access your account', style: TextStyle(color: Colors.black54)),
                SizedBox(height: 24),
                Align(
